...
#define GDT_CODE_0_SEL  (uint16_t)(GDT_IDX_CODE_0<<3)      //0000000000001000
#define GDT_DATA_0_SEL  (uint16_t)(GDT_IDX_DATA_0<<3)  
#define GDT_CODE_3_SEL  (uint16_t)(GDT_IDX_CODE_3<<3 | 0x3)
#define GDT_DATA_3_SEL  (uint16_t)(GDT_IDX_DATA_3<<3 | 0x3)
...
#define VIDEO_SEGM_SIZE  50*80*2 //(en bytes?)
