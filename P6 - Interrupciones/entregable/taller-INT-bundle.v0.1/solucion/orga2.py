...
def format_gdt_entry(entry_bytes):
        ...
        entry_g = (entry[6] & 0x08)
        entry_db = bool(entry[6] & 0x04)
        entry_a = bool(entry[6] & 0x01)
...
class GDTPrinter:
    ...
    def children(self):
        ...
        limit = self.val['limit_19_16'] << 16 | self.val['limit_15_0']
        yield 'limit', limit.cast(u32)
        base = self.val['base_31_24'] << 24 | self.val['base_23_16'] << 16 | self.val['base_15_0']
...
class IDTPrinter:
    ...
    def children(self):
        void_star = gdb.lookup_type('void').pointer()
        offset = self.val['offset_31_16'] << 16 | self.val['offset_15_0']
