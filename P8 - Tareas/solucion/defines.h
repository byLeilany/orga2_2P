...
MMU_ENTRY_PADDR(X)  devuelve la dirección física de la base de un page frame o de un page table, 
donde X es el campo de 20 bits en una PTE o PDE
*/

#define VIRT_PAGE_OFFSET(X) (uint32_t)(X & 0xFFF)
#define VIRT_PAGE_TABLE(X)  (uint32_t)((X >> 12) & 0x3FF)
#define VIRT_PAGE_DIR(X)    (uint32_t)((X >> 22) & 0x3FF)
#define CR3_TO_PAGE_DIR(X)  (uint32_t)(X & 0xFFFFF000)
#define MMU_ENTRY_PADDR(X)  (uint32_t)(X << 12)
...
#define TASK_STACK_BASE   0x08002000//antes:0x08003000
#define TASK_SHARED_PAGE  0x08003000 
#define TASK_KERNEL_STACK_BASE  0x08004000
