...
/*
a)
50: busca el siguiente ID libre en el scheduler para la tarea
51: crea la TSS para la tarea con ese ID
52: agrega una entry a la GDT en el ID libre con el descriptor de la TSS creada.

b)Porque queremos armar un selector, y este tiene los 3 bits menos significativos los atributos, y en los otros el índice de la GDT 
*/
